...
7. Create and push a matching tag, for example `git tag v1.0.1` then `git push origin v1.0.1`.
8. Let GitHub Actions build the Release configuration and attach `latest.zip` to the GitHub release.
